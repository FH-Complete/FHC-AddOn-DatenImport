...
foreach ($diq->result as $diquelle)
{
	...
	$htmlstr .= "   <tr>\n";
	$htmlstr .= "       <td><a href='dim_details.php?diq_id=".$diquelle->diq_id."' target='dim_details'>".$diquelle->diq_id."</a></td>".$nl;
	$htmlstr .= "       <td><a href='dim_details.php?diq_id=".$diquelle->diq_id."' target='dim_details'>".$diquelle->diq_tablename."</a></td>".$nl;
	$htmlstr .= "       <td><a href='dim_details.php?diq_id=".$diquelle->diq_id."' target='dim_details'>".$diquelle->diq_viewname."</a></td>".$nl;
	$htmlstr .= "   </tr>".$nl;
	$i++;
}
