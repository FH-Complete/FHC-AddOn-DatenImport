...
<head>
	...
	<title>LBS Datenmigration - IMM Course</title>
</head>
<body>
<h1>LBS Datenmigration - IMM Course</h1>';
...
$studiengang_kz=90; // IMM

//Alle Einträge in der Tabelle lbs_imm_course durchlaufen
$qry_course = "SELECT * FROM sync.lbs_imm_course";
...
logMessage("----------------------------------------------------");
logMessage("Lehrveranstaltungen: $statistik_lehrveranstaltung_neu / 0 / $statistik_lehrveranstaltung_fehler");
