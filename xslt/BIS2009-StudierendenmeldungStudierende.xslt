...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/Erhalter">
		<xsl:text>"ErhKz","MeldeDatum","StgKz","PersKz","OrgFormCode","GeburtsDatum","Geschlecht","SVNR","StaatsangehoerigkeitCode","HeimatPLZ","HeimatGemeinde","HeimatStrasse","HeimatNation","ZugangCode","ZugangDatum","BeginnDatum","BeendigungsDatum","Ausbildungssemester","StudStatusCode","StandortCode","BMWFfoerderrelevant"
</xsl:text>
